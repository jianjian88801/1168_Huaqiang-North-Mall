...
//                            shangpinOrderEntity.setBuyNumber(Integer.valueOf(data.get(0)));   //购买的数量 要改的
    ...
    */
    ...
    public R add(@RequestBody ShangpinOrderEntity shangpinOrder, HttpServletRequest request){
        ...
        if("用户".equals(role)){
            ...
            shangpinOrder.setShangpinOrderTypes(2); //设置订单状态为已支付
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            ...
            shangpinOrderEntity.setBuyNumber(buyNumber);//购买的数量 ？？？？？？
            shangpinOrderEntity.setShangpinOrderTypes(2);//订单类型
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        if("用户".equals(role)){
            ...
            shangpinOrder.setShangpinOrderTypes(1);//设置订单状态为退款
            shangpinOrderService.updateById(shangpinOrder);//根据id更新
    ...
    public R deliver(Integer id){
        ...
        shangpinOrderEntity.setShangpinOrderTypes(3);
