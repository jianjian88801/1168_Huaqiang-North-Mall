            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shangjia'">
                    <el-form-item class="select" v-if="type!='info'"  label="商家" prop="shangjiaId">
                        <el-select v-model="ruleForm.shangjiaId" filterable placeholder="请选择商家" @change="shangjiaChange">
                            <el-option
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="商品类型" prop="shangpinTypes">
                        <el-select v-model="ruleForm.shangpinTypes" placeholder="请选择商品类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品现价" prop="shangpinNewMoney">
                       <el-input v-model="ruleForm.shangpinNewMoney"
                                 placeholder="商品现价" clearable  :readonly="ro.shangpinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="商品现价" prop="shangpinNewMoney">
                           <el-input v-model="ruleForm.shangpinNewMoney"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.shangpinOldMoney = true;
                this.ro.shangpinNewMoney = true;
            }
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangjiaId'){
                          this.ruleForm.shangjiaId = obj[o];
                      ...
                      if(o=='shangpinOldMoney'){
                          this.ruleForm.shangpinOldMoney = obj[o];
                          this.ro.shangpinOldMoney = true;
                          continue;
                      }
                      if(o=='shangpinNewMoney'){
                          this.ruleForm.shangpinNewMoney = obj[o];
                          this.ro.shangpinNewMoney = true;
                          continue;
                      }
                      if(o=='shangxiaTypes'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.shangjiaChange(data.data.shangjiaId)
                        //解决前台上传图片后台不显示的问题
