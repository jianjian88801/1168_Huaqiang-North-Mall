               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="新闻类型" prop="newsTypes">
                        <el-select v-model="ruleForm.newsTypes" placeholder="请选择新闻类型">
                            <el-option
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '新闻发布时间不能为空', trigger: 'blur' },
                          ],
                   newsContent: [
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='newsName'){
                          this.ruleForm.newsName = obj[o];
                          this.ro.newsName = true;
                          continue;
                      }
                      if(o=='newsPhoto'){
                          this.ruleForm.newsPhoto = obj[o];
                          this.ro.newsPhoto = true;
                          continue;
                      }
                      if(o=='newsTypes'){
                          this.ruleForm.newsTypes = obj[o];
                          this.ro.newsTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
                      ...
                      if(o=='newsContent'){
                          this.ruleForm.newsContent = obj[o];
                          this.ro.newsContent = true;
                          continue;
                      }
                    }
                }
