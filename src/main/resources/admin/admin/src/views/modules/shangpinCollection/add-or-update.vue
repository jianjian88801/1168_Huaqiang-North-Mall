    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="shangpinCollectionTypes">
                        <el-select v-model="ruleForm.shangpinCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in shangpinCollectionTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="shangpinCollectionValue">
                        <el-input v-model="ruleForm.shangpinCollectionValue"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangpin_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shangpinCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangpinCollectionTypes'){
                          this.ruleForm.shangpinCollectionTypes = obj[o];
                          this.ro.shangpinCollectionTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    url: `shangpinCollection/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shangpinCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shangpinCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
