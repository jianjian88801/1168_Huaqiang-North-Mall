               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="收货人" prop="addressName">
                       <el-input v-model="ruleForm.addressName"
                                 placeholder="收货人" clearable  :readonly="ro.addressName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电话" prop="addressPhone">
                       <el-input v-model="ruleForm.addressPhone"
                                 placeholder="电话" clearable  :readonly="ro.addressPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="地址" prop="addressDizhi">
                       <el-input v-model="ruleForm.addressDizhi"
                                 placeholder="地址" clearable  :readonly="ro.addressDizhi"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否默认地址" prop="isdefaultTypes">
                        <el-select v-model="ruleForm.isdefaultTypes" placeholder="请选择是否默认地址">
                            <el-option
                                v-for="(item,index) in isdefaultTypesOptions"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=isdefault_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.isdefaultTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='addressName'){
                          this.ruleForm.addressName = obj[o];
                          this.ro.addressName = true;
                          continue;
                      }
                      if(o=='addressPhone'){
                          this.ruleForm.addressPhone = obj[o];
                          this.ro.addressPhone = true;
                          continue;
                      }
                      if(o=='addressDizhi'){
                          this.ruleForm.addressDizhi = obj[o];
                          this.ro.addressDizhi = true;
                          continue;
                      }
                      if(o=='isdefaultTypes'){
                          this.ruleForm.isdefaultTypes = obj[o];
                          this.ro.isdefaultTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
