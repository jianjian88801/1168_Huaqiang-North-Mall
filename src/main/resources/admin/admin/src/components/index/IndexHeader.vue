    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {},
                user: {},
                heads: {"headLogoutFontHoverColor":"#fff","headFontSize":"20px","headUserInfoFontColor":"rgba(254, 254, 254, 1)","headBoxShadow":"0 0px 0px #444","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"#333","headFontColor":"rgba(254, 254, 254, 1)","headTitleImg":false,"headHeight":"80px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"#FEBE00","headTitleImgBoxShadow":"0 0px 0px #444","headLogoutFontColor":"rgba(254, 254, 254, 1)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"1","headLogoutFontSize":"16px"},
            };
        },
        created() {
            this.setHeaderStyle()
