    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='address'">
                    <el-form-item class="select" v-if="type!='info'"  label="收货地址" prop="addressId">
                        <el-select v-model="ruleForm.addressId" filterable placeholder="请选择收货地址" @change="addressChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='address' ">
                    <el-form-item class="input" v-if="type!='info'"  label="是否默认地址" prop="isdefaultValue">
                        <el-input v-model="addressForm.isdefaultValue"
                                  placeholder="是否默认地址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否默认地址" prop="isdefaultValue">
                            <el-input v-model="ruleForm.isdefaultValue"
                                      placeholder="是否默认地址" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shangpin'">
                    <el-form-item class="select" v-if="type!='info'"  label="商品信息" prop="shangpinId">
                        <el-select v-model="ruleForm.shangpinId" filterable placeholder="请选择商品信息" @change="shangpinChange">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单号" prop="shangpinOrderUuidNumber">
                       <el-input v-model="ruleForm.shangpinOrderUuidNumber"
                                 placeholder="订单号" clearable  :readonly="ro.shangpinOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="购买的数量" prop="buyNumber">
                       <el-input v-model="ruleForm.buyNumber"
                                 placeholder="购买的数量" clearable  :readonly="ro.buyNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="购买的数量" prop="buyNumber">
                           <el-input v-model="ruleForm.buyNumber"
                                     placeholder="购买的数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="shangpinOrderTypes">
                        <el-select v-model="ruleForm.shangpinOrderTypes" placeholder="请选择订单类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="shangpinOrderPaymentTypes">
                        <el-select v-model="ruleForm.shangpinOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                                v-for="(item,index) in shangpinOrderPaymentTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
    ...
    export default {
        data() {
            return {
                ...
                shangpinOrderPaymentTypesOptions : [],
                addressOptions : [],
                shangpinOptions : [],
                yonghuOptions : [],
                rules: {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangpin_order_payment_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shangpinOrderPaymentTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangpinOrderUuidNumber'){
                          this.ruleForm.shangpinOrderUuidNumber = obj[o];
                          this.ro.shangpinOrderUuidNumber = true;
                          continue;
                      }
                      if(o=='addressId'){
                      ...
                      if(o=='shangpinOrderTruePrice'){
                          this.ruleForm.shangpinOrderTruePrice = obj[o];
                          this.ro.shangpinOrderTruePrice = true;
                          continue;
                      }
                      if(o=='shangpinOrderTypes'){
                          this.ruleForm.shangpinOrderTypes = obj[o];
                          this.ro.shangpinOrderTypes = true;
                          continue;
                      }
                      if(o=='shangpinOrderPaymentTypes'){
                          this.ruleForm.shangpinOrderPaymentTypes = obj[o];
                          this.ro.shangpinOrderPaymentTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
