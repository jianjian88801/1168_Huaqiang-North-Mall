    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商家名称" prop="shangjiaName">
                       <el-input v-model="ruleForm.shangjiaName"
                                 placeholder="商家名称" clearable  :readonly="ro.shangjiaName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="shangjiaPhone">
                       <el-input v-model="ruleForm.shangjiaPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.shangjiaPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="shangjiaEmail">
                       <el-input v-model="ruleForm.shangjiaEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.shangjiaEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangjiaPhoto" label="营业执照" prop="shangjiaPhoto">
                        <file-upload
                            tip="点击上传营业执照"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangjiaPhoto" label="营业执照" prop="shangjiaPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现有余额" prop="newMoney">
                       <el-input v-model="ruleForm.newMoney"
                                 placeholder="现有余额" clearable  :readonly="ro.newMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现有余额" prop="newMoney">
                           <el-input v-model="ruleForm.newMoney"
                                     placeholder="现有余额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="商家简介" prop="shangjiaContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangjiaContent" label="商家简介" prop="shangjiaContent">
                            <span v-html="ruleForm.shangjiaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   newMoney: [
                              { required: true, message: '现有余额不能为空', trigger: 'blur' },
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangjiaName'){
                          this.ruleForm.shangjiaName = obj[o];
                          this.ro.shangjiaName = true;
                          continue;
                      }
                      if(o=='shangjiaPhone'){
                          this.ruleForm.shangjiaPhone = obj[o];
                          this.ro.shangjiaPhone = true;
                          continue;
                      }
                      if(o=='shangjiaEmail'){
                          this.ruleForm.shangjiaEmail = obj[o];
                          this.ro.shangjiaEmail = true;
                          continue;
                      }
                      if(o=='shangjiaPhoto'){
                          this.ruleForm.shangjiaPhoto = obj[o];
                          this.ro.shangjiaPhoto = true;
                          continue;
                      }
                      if(o=='newMoney'){
                      ...
                      if(o=='shangjiaContent'){
                          this.ruleForm.shangjiaContent = obj[o];
                          this.ro.shangjiaContent = true;
                          continue;
                      }
                      if(o=='shangjiaDelete'){
                          this.ruleForm.shangjiaDelete = obj[o];
                          this.ro.shangjiaDelete = true;
                          continue;
                      }
                    }
                }
